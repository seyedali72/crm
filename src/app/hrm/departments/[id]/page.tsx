...
export default function DepartmentDetail() {
    ...
    const handleEditDepartments = async (obj: any) => {
        ...
        if (!res.error) {
            router.replace('/hrm/departments')
        }
    }
            ...
            <>
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item "><Link href="/hrm/departments"> لیست دپارتمان ها</Link></li>
                ...
                {singleDepartment?.users.length !== 0 && <section className="main-body-container rounded">
                    ...
                    <section className="table-responsive">
                        <table className="table table-hover table-striped">
                            ...
                            <tbody>
                                {singleDepartment?.users.map((employe: any, idx: number) => {
