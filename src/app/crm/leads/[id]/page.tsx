...
export default function EditLead() {
    ...
    const [oppoList, setOppoList] = useState<any>([])
    ...
    const fetchLead = useCallback(async () => {
        if (user?._id !== undefined) {
            ...
            let oppo = await getOpportunities({ isDeleted: false, leadId: lead?._id })
            setOppoList(oppo)
        }
    }, [user])
    useEffect(() => {
            ...
            <>
                ...
                <section className="d-flex flex-column flex-md-row">
                            ...
                            <form action="post" onSubmit={handleSubmit(handleEditLead)} method='Post'>
                                <section className="row">
                                    ...
                                    <div className="col-12 col-md-6">
                                        ...
                                        {!editInfo ? <p>{singleLead?.phone_number_2} </p> : <input type="number" className="form-control form-control-sm" {...register('phone_number_2')} />}
                                    </div>
                                    <div className="col-12 col-md-6">
                    ...
                    <section className="col-md-4 pe-2">
                        <MoreInfo owner={owner} singleLead={singleLead} mutated={() => setMutated(!mutated)} />
                        <OpportunitySection owner={owner} singleLead={singleLead} mutated={() => setMutated(!mutated)} opportunitiesList={oppoList} />
