                ...
                <form action="post" onSubmit={handleSubmit(handleCreateCustomerCats)} method='Post'>
                    <section className="row">
                        <div className="col-12 col-md-6">
                            ...
                            <input type="text" className="form-control form-control-sm" placeholder="عنوان زمینه فعالیت" {...register('name', { required: 'عنوان زمینه فعالیت را وارد کنید', })} />
                        </div>
                        <div className="col-12 col-md-6">
                            <label className='my-1' htmlFor="">زمینه فعالیت والد </label>
                            <select className="form-control form-control-sm" onChange={(e: any) => setValue('parent', e.target.value)}><option value='' hidden>یک زمینه فعالیت را انتخاب کنید</option>
                                ...
                                if (cat.name.includes(filter)) {
                                    return (<tr key={idx}>
                                        ...
                                        <td className="text-center">
                                            <Link href={`/crm/customers/categories/${cat?._id}`} className="btn btn-sm bg-custom-4 ms-1" ><i className="fa fa-edit px-1"></i>جزئیات</Link>
