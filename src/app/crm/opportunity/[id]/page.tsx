            ...
            <>
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb mb-0">
                        ...
                        <li className="breadcrumb-item"><Link href="/crm/opportunity">لیست فرصت های فروش ها</Link></li>
                            ...
                            <form action="post" onSubmit={handleSubmit(handleEditOpportunity)} method='Post'>
                                <section className="row">
                                    ...
                                    <div className="col-12 col-md-6">
                                        ...
                                        <Link href={`/crm/leads/${singleOpportunity?.leadId?._id}`} className="d-block">{singleOpportunity?.leadId?.isCompany ? singleOpportunity?.leadId?.companyId?.name : singleOpportunity?.leadId?.contatcId?.name}  </Link>
                                    </div>
                                    <div className="col-12 col-md-6">
