      ...
      <main>
        <div style={{ display: 'flex', width: '100%' }}>
          <form style={{ width: '30%', padding: 10 }} action="post" onSubmit={handleSubmit(handleCreateEmploye)}>
            ...
            <input type="number" style={{ display: 'block', width: '90%', margin: '10px 0', padding: '5px 15px' }} placeholder='شماره ملی'	{...register('national_code', { required: 'شماره ملی را وارد کنید', })} />
          ...
          <div style={{ maxHeight: "80vh", overflowY: 'scroll', width: '70%', padding: 10 }}>
            ...
            <input type="text" onChange={(e: any) => setFilter(e.target.value)} style={{ display: 'block', width: '90%', margin: '10px 0', padding: '5px 15px' }} placeholder='براساس نام یا شماره ملی فیلتر کنید' />
